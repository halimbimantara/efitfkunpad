...
public class FragmentGrafikAsupan extends BaseFragment{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String url="http://fit.coderantik.id/webapp/fit_lapasupanmakan/grafikmakanan?id_user="+ Sharepref.getString(Constant.USERID);
